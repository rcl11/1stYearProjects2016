...
// Thu May  5 14:55:26 2016 by ROOT version 5.34/18
// from TChain ntuple/
//////////////////////////////////////////////////////////

#ifndef VBFAnalysis_h
#define VBFAnalysis_h
...
#ifdef VBFAnalysis_cxx
VBFAnalysis::VBFAnalysis(TTree *tree) : fChain(0) 
{
...
Int_t VBFAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t VBFAnalysis::LoadTree(Long64_t entry)
{
...
void VBFAnalysis::Init(TTree *tree)
{
...
void VBFAnalysis::Show(Long64_t entry)
{
...
Int_t VBFAnalysis::Cut(Long64_t entry)
{

...
// Wed May 25 16:11:11 2016 by ROOT version 5.34/04
// from TChain ntuple/
//////////////////////////////////////////////////////////
...
#ifdef Background_cxx
Background::Background(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("DYJetsToLL_M-50-LO-ext_mt_2015.root/ntuple");
      tree = chain;
#endif // SINGLE_TREE
...
Int_t Background::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Background::LoadTree(Long64_t entry)
{
...
void Background::Init(TTree *tree)
{
...
void Background::Show(Long64_t entry)
{
...
Int_t Background::Cut(Long64_t entry)
{
